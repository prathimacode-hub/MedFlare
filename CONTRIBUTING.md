...
Welcome to [prathimacode-hub/MedFlare](https://github.com/prathimacode-hub/MedFlare/). Before sending your pull requests, make sure that you **read the whole
...
* Step 2: Add a upstream link to main branch in your cloned repo
    ```
    git remote add upstream https://github.com/prathimacode-hub/MedFlare.git
    ```
* Step 3: Keep your cloned repo upto date by pulling from upstream (this will also avoid any merge conflicts while committing new changes)
    ```
    git pull upstream main https://github.com/prathimacode-hub/MedFlare.git
    ```
...
- Do not update the [README.md](https://github.com/prathimacode-hub/MedFlare/blob/main/README.md) and [Contributing_Guidelines.md](https://github.com/prathimacode-hub/MedFlare/blob/main/CONTRIBUTING.md).
